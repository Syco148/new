...
\033[1;93m______________________________________________________
 ...
 \033[1;93m(*)\033[1;92m Developer : Syco Queen 
 \033[1;93m(*)\033[1;92m Tool Type : SIM & CNIC DETAILS \033[1;93m(Only For Pak)
 \033[1;93m(*)\033[1;92m YouTube   : SYCO QUEEN 
...
def main():
       ...
       # os.system('xdg-open https://youtube.com/c/SYEDZADA1100')
        ...
        print(54 * "\x1b[1;93m_")
        print("")
        SYCO = input('\x1b[1;93m[+] Choose Option: \x1b[1;92m')
        if SYCO == '':
                ...
                os.system('xdg-open https://chat.whatsapp.com/+1 (986) 867-6563')
                main()
        elif SYCO == '4':
                os.system('xdg-open https://www.facebook.com/profile.php?id=100070832225045)
                main()
        elif SYCO == '0':
                os.system('exit')
        else:
...
def meta_data():
        ...
        for szs in range(15):
                ...
                if str(f"{szs+1}.") in soup.text:
                        print(f"\n{G}[+] "+str(szs+1)+" RECORD ")
                        print("")
                        print(f"{S}[✓] NAME    :{G} {s1[szs].text}")
                        print(f"{S}[✓] NUMBER  :{G} {s[szs].text}")
                        print(f"{S}[✓] CNIC    :{G} {s2[szs].text}")
                        print(f"{S}[✓] ADDRESS :{G} {s3[szs].text}")
                        done.append("done")
                else:
                        pass
        if str("done") in done:
